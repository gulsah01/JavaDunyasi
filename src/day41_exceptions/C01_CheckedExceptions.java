...
public class C01_CheckedExceptions {
    ...
    /*
    Java daki FileInputStream classi
    bilgisayarimizda var olan herhangi bir dosyaya erismek icin kullanilir.

    FileInputStream classindan olusturdugumuz fis objesinin
    istedigimiz doyayi bulabilmesi icin obje olusturulurken
    istedigimiz dosyanin DOSYA YOLUnu parametre olarak vermeliyiz.
